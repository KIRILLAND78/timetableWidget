...
│
├── PythonGTK/                    # Python GTK приложение (универсальное)
...
#### Linux (Python GTK - универсальное)
Работает на XFCE, MATE, LXQt, Budgie и любых других DE:
```bash
cd PythonGTK
./install.sh
# Затем: timetable-widget или найдите в меню приложений
```

См. [PythonGTK/README.md](PythonGTK/README.md) для подробной инструкции.
...
- [x] **GNOME Shell Extension для Linux** (JavaScript/GJS)
  ...
  - [x] Автоматическое обновление
- [x] **Python GTK приложение для Linux** (Python + GTK3)
  - [x] GTK диалоги авторизации и настроек
  - [x] Frameless окно на рабочем столе
  - [x] Работает на ВСЕХ DE (XFCE, MATE, LXQt и др.)
  - [x] Перетаскивание и автоматическое обновление
